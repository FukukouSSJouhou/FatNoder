...
{
    /// <summary>
    /// NodeModelのEnumerator!(保存用)
    /// </summary>
    public class NodeModelEnumerator_ExSave: IEnumerator<XML_NodeModel>
    {
        ...
        public NodeModelEnumerator_ExSave(XML_NodeModel root, IEnumerable<XML_NodeModel> nodes)
        {
            _Current = null;
            _root = root;
            _nodes = nodes;
